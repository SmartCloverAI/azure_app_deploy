...
price_sensitivity_train_df = pd.read_csv(args.input_data_train)

training_results = {}
columns_training_table = list(price_sensitivity_train_df.columns)
...
price_sensitivity_train_df['START_DATE_WEEK'] = pd.to_datetime(price_sensitivity_train_df['START_DATE_WEEK'], errors='coerce')
price_sensitivity_train_df['year'] = price_sensitivity_train_df['START_DATE_WEEK'].dt.year
price_sensitivity_train_df['month'] = price_sensitivity_train_df['START_DATE_WEEK'].dt.month
price_sensitivity_train_df['week'] = price_sensitivity_train_df['START_DATE_WEEK'].dt.day_of_week
price_sensitivity_train_df['day'] = price_sensitivity_train_df['START_DATE_WEEK'].dt.day

price_sensitivity_train_df = price_sensitivity_train_df.drop(columns = ['START_DATE_WEEK'])
price_sensitivity_train_df = price_sensitivity_train_df.fillna(0)

#Pregatirea setului de test
price_sensitivity_test_df = pd.read_csv(args.input_data_test)

price_sensitivity_test_df['START_DATE_WEEK'] = pd.to_datetime(price_sensitivity_test_df['START_DATE_WEEK'], errors='coerce')
price_sensitivity_test_df['year'] = price_sensitivity_test_df['START_DATE_WEEK'].dt.year
price_sensitivity_test_df['month'] = price_sensitivity_test_df['START_DATE_WEEK'].dt.month
price_sensitivity_test_df['week'] = price_sensitivity_test_df['START_DATE_WEEK'].dt.day_of_week
price_sensitivity_test_df['day'] = price_sensitivity_test_df['START_DATE_WEEK'].dt.day

price_sensitivity_test_df = price_sensitivity_test_df.drop(columns = ['START_DATE_WEEK'])
price_sensitivity_test_df = price_sensitivity_test_df.fillna(0)

y_train = price_sensitivity_train_df[['VENIT','CHELTUIALA','TVA IN','TVA OUT','CASHFLOW']]
X_train = price_sensitivity_train_df.drop(columns = ['VENIT','CHELTUIALA','TVA IN','TVA OUT','CASHFLOW'])

y_test = price_sensitivity_test_df[['VENIT','CHELTUIALA','TVA IN','TVA OUT','CASHFLOW']]
X_test = price_sensitivity_test_df.drop(columns = ['VENIT','CHELTUIALA','TVA IN','TVA OUT','CASHFLOW'])
...
price_sensitivity_model.save(output_model_path + "price_sensitivity.keras")
